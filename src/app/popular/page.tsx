...
function Popular() {
    ...
    useEffect(() => {
        const loadMovies = async () => {
            try {
                const { movies: fetchedMovies, totalPages: fetchedTotalPages } = await fetchMovies(currentPage, 'popular');
    ...
    return (
        <div>
            <div className="my-16 p-4 flex flex-col items-center" ref={popularRef}>
